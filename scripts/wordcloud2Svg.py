...
dir_path = os.path.normpath(os.path.join(BIN, "../../../"))  # 本博客对应的是/src目录

output_path = os.path.normpath(
    os.path.join(BIN, "../assets/img")
)  # 本博客对应的是/src/.vuepress/public/assets/img目录

font_path = os.path.normpath(
    os.path.join(BIN, "./font.otf")
)  # 本博客对应的是/src/.vuepress/public/scripts/font.otf

output_path_svg = os.path.normpath(
    os.path.join(BIN, "../assets/img/wordcloud.svg")
)  # 本博客对应的是/src/.vuepress/public/assets/img/wordcloud.svg

# print(f"dir_path:{dir_path}\n\noutput_path:{output_path}\n\nfont_path:{font_path}\n\noutput_path_svg:{output_path_svg}\n\n")

with open(os.path.join(BIN, "keyword_old.txt"), "r", encoding="utf-8") as f:
...
if __name__ == "__main__":
    ...
    keywords = jieba.analyse.textrank(
        contents, topK=150, withWeight=False, allowPOS=("ns", "n", "vn", "v")
    )
