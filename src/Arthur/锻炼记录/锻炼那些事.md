...
:::important 总结
在 2019.8.31-2020.7.31 期间，我总共跑了 773.2 公里，跑步 95 次
:::
:::echarts

```js
const data = await fetch(
  "https://raw.githubusercontent.com/arthurfsy2/yunmai_weight_extract2json/main/output/weight_fsy.json"
).then((res) => res.json());
...
:::important 总结
在 2020.8.1-2021.8.26 期间，我总共跑了 305.46 公里，跑步 47 次。其中 8 月在跑步机上总共跑了 29.85 公里、6 次，目前体重 81.3KG
:::
...
:::important 总结
2024年是骑行“热恋期”，也在6月底第一次完成百公里骑行后，立下了总共要完成100个百公里骑行的“宏愿”。
在密集、高强度骑行之下，体重明显下降，到2024 年 9 月 14 日到达最低谷：72.37kg（这个时候的我非常有成就感）

在 2023.12.25-2024.12.25 的 1 年期间，我总共骑行 214 次，总里程3024.69 公里（一般骑行当天一天 2 次，周末偶尔在吴女士值班的时候骑一下）
:::
...
## 2025/12/25：体重“过山车”又来啦

> 果然逃不过铁律：老婆怀孕，老公体重跟着猛涨。

这不，弟弟是2025年3月底怀上的，2025年12月25日（圣诞节）出生的，体重在8月前还能勉强保持76kg，在10月份以后就又彻底绷不住了,在2025年12月23日到达顶峰：82.45kg。
这其实也在预料当中：自从2025年9月开始，笑笑就开始上幼儿园了，需要接送。导致从9月份开始就不怎么通勤骑行。且后面饮食也彻底放飞自我，小啤酒、小白酒都成为日常“小酌”。

计划今年开始恢复锻炼，在吴女士坐月子期间，也尝试恢复跑步，后面再看看自己的毅力吧。
:::echarts
...
const option = {
   title: [
    {
      left: 'center',
      text: '2025-12-25至2026-01-16体重变化'
    }
  ],
  tooltip: {
    trigger: "axis",
  ...
  dataZoom: 
    {
      startValue: "2024-12-25 08:07:50",
      // endValue: "2025-12-16 23:59:59",
      type: "inside",
    },
  visualMap: [
    {
