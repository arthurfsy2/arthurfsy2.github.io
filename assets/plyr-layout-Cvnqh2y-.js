var te=Object.defineProperty;var Q=e=>{throw TypeError(e)};var ae=(e,t,a)=>t in e?te(e,t,{enumerable:!0,configurable:!0,writable:!0,value:a}):e[t]=a;var F=(e,t,a)=>ae(e,typeof t!="symbol"?t+"":t,a),G=(e,t,a)=>t.has(e)||Q("Cannot "+a);var h=(e,t,a)=>(G(e,t,"read from private field"),a?a.call(e):t.get(e)),x=(e,t,a)=>t.has(e)?Q("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,a),V=(e,t,a,n)=>(G(e,t,"write to private field"),n?n.call(e,a):t.set(e,a),a),j=(e,t,a)=>(G(e,t,"access private method"),a);import{Q as ne,S as _,U as se,V as M,Z as k,a3 as le,P as re,bf as oe,al as ie,ae as ue,f as pe,R as ce,ai as de,a6 as me,a0 as _e,a7 as ye,am as $e,a_ as H,aj as K,ar as r}from"./app-CudkpxlJ.js";import{e as be,g as fe,h as ve,j as ge,i as we,k as Te,l as he,E as ke,n as Me,o as xe,p as Pe,t as Ee,q as Ce,u as Le,v as Se,w as Be,x as Ae,y as Re,z as De,A as Ie,B as Fe,C as Ge,F as Ve,D as qe}from"./vidstack-D_DrbzHZ-Db05A8eP.js";import{L as Oe,x as s}from"./vidstack-CwTj4H1w-Bp4ARBvF.js";import{S as Qe,$ as l,L as je,I as Ne,o as U}from"./vidstack-7xep0lg7-BdpWcISp.js";import{MediaPosterElement as He}from"./vidstack-QR8zGkwr-CUM3mhJ8.js";const z=le();function o(){return re(z)}const Ke={clickToPlay:!0,clickToFullscreen:!0,controls:["play-large","play","progress","current-time","mute+volume","captions","settings","pip","airplay","fullscreen"],customIcons:!1,displayDuration:!1,download:null,markers:null,invertTime:!0,thumbnails:null,toggleTime:!0,translations:null,seekTime:10,speed:[.5,.75,1,1.25,1.5,1.75,2,4]};var P;class Z extends ne{constructor(){super(...arguments);x(this,P)}onSetup(){V(this,P,_()),se(z,{...this.$props,previewTime:M(0)})}}P=new WeakMap,F(Z,"props",Ke);function Ue(e,t){const{canAirPlay:a,canFullscreen:n,canPictureInPicture:u,controlsHidden:m,currentTime:$,fullscreen:p,hasCaptions:d,isAirPlayConnected:y,paused:f,pictureInPicture:w,playing:S,pointer:B,poster:A,textTrack:R,viewType:c,waiting:g}=t.$state;e.classList.add("plyr"),e.classList.add("plyr--full-ui");const T={"plyr--airplay-active":y,"plyr--airplay-supported":a,"plyr--fullscreen-active":p,"plyr--fullscreen-enabled":n,"plyr--hide-controls":m,"plyr--is-touch":()=>B()==="coarse","plyr--loading":g,"plyr--paused":f,"plyr--pip-active":w,"plyr--pip-enabled":u,"plyr--playing":S,"plyr__poster-enabled":A,"plyr--stopped":()=>f()&&$()===0,"plyr--captions-active":R,"plyr--captions-enabled":d},D=oe();for(const v of Object.keys(T))D.add(k(()=>void e.classList.toggle(v,!!T[v]())));return D.add(k(()=>{const v=`plyr--${c()}`;return e.classList.add(v),()=>e.classList.remove(v)}),k(()=>{var O;const{$provider:v}=t,I=(O=v())==null?void 0:O.type,q=`plyr--${ze(I)?"html5":I}`;return e.classList.toggle(q,!!I),()=>e.classList.remove(q)})),()=>D.empty()}function ze(e){return e==="audio"||e==="video"}class Ze extends je{async loadIcons(){const t=(await pe(async()=>{const{icons:n}=await import("./vidstack-DXxIKXmd-Dge3KT8k.js");return{icons:n}},[])).icons,a={};for(const n of Object.keys(t))a[n]=Ne({name:n,paths:t[n],viewBox:"0 0 18 18"});return a}}function C(e,t){var a;return((a=e())==null?void 0:a[t])??t}function Je(){return et()}function We(){const e=_(),{load:t}=e.$props,{canLoad:a}=e.$state;return ce(()=>t()==="play"&&!a())()?[J(),N()]:[Xe(),Ye(),N(),tt(),$t(),bt()]}function J(){const e=_(),{translations:t}=o(),{title:a}=e.$state,n=l(()=>`${C(t,"Play")}, ${a()}`);return s`
  ...
  `}function ct(){let e=_(),{duration:t,viewType:a}=e.$state,{translations:n,markers:u,thumbnails:m,seekTime:$,previewTime:p}=o(),d=i(n,"Seek"),y=M(null),f=l(()=>{const c=y();return c?s`<span class="plyr__progress__marker-label">${U(c.label)}<br /></span>`:null});function w(c){p.set(c.detail)}function S(){y.set(this)}function B(){y.set(null)}function A(){const c=m(),g=l(()=>a()==="audio");return c?s`
        ...
        `}function R(){var g;const c=t();return Number.isFinite(c)?(g=u())==null?void 0:g.map(T=>s`
        <span
  ...
  `}function _t(){const e=_(),{translations:t,invertTime:a,toggleTime:n,displayDuration:u}=o(),m=M(de(a));function $(d){!n()||u()||H(d)&&!K(d)||m.set(y=>!y)}function p(){return l(()=>u()?X():null)}return l(()=>{const{streamType:d}=e.$state,y=i(t,"LIVE"),f=i(t,"Current time"),w=l(()=>!u()&&m());return d()==="live"||d()==="ll-live"?s`
          <media-live-button
  ...
  `}function gt(){return L({label:"Audio",children:wt()})}function wt(){const{translations:e}=o();return s`
  ...
  `}function Tt(){return L({label:"Speed",children:ht()})}function ht(){const{translations:e,speed:t}=o();return s`
