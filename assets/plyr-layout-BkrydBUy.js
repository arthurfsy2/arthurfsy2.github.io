var te=Object.defineProperty;var Q=e=>{throw TypeError(e)};var ae=(e,t,a)=>t in e?te(e,t,{enumerable:!0,configurable:!0,writable:!0,value:a}):e[t]=a;var F=(e,t,a)=>ae(e,typeof t!="symbol"?t+"":t,a),G=(e,t,a)=>t.has(e)||Q("Cannot "+a);var h=(e,t,a)=>(G(e,t,"read from private field"),a?a.call(e):t.get(e)),x=(e,t,a)=>t.has(e)?Q("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,a),V=(e,t,a,n)=>(G(e,t,"write to private field"),n?n.call(e,a):t.set(e,a),a),N=(e,t,a)=>(G(e,t,"access private method"),a);import{Q as ne,S as _,U as se,V as M,Z as k,a3 as le,P as re,be as oe,ak as ie,ad as ue,f as pe,R as ce,ah as de,a6 as me,al as _e,aZ as H,ai as K,aq as i}from"./app-Cq0-ZXEd.js";import{g as ye,h as $e,i as be,k as fe,j as ve,l as ge,n as we,E as Te,o as he,p as ke,q as Me,u as xe,t as Pe,v as Ee,w as Ce,x as Le,y as Be,z as Se,A as Ae,B as De,C as Ie,F as Re,D as Fe}from"./vidstack-BOLMn4nu-BOsIeLRH.js";import{L as Ge,x as s}from"./vidstack-CwTj4H1w-Bp4ARBvF.js";import{S as Ve,$ as l,L as qe,I as Oe,o as U}from"./vidstack-7xep0lg7-Ct3OxJAo.js";import{MediaPosterElement as Qe}from"./vidstack-DiirHtXs-BBkqt49r.js";const Z=le();function r(){return re(Z)}const Ne={clickToPlay:!0,clickToFullscreen:!0,controls:["play-large","play","progress","current-time","mute+volume","captions","settings","pip","airplay","fullscreen"],customIcons:!1,displayDuration:!1,download:null,markers:null,invertTime:!0,thumbnails:null,toggleTime:!0,translations:null,seekTime:10,speed:[.5,.75,1,1.25,1.5,1.75,2,4]};var P;class z extends ne{constructor(){super(...arguments);x(this,P)}onSetup(){V(this,P,_()),se(Z,{...this.$props,previewTime:M(0)})}}P=new WeakMap,F(z,"props",Ne);function je(e,t){const{canAirPlay:a,canFullscreen:n,canPictureInPicture:u,controlsHidden:d,currentTime:$,fullscreen:m,hasCaptions:c,isAirPlayConnected:y,paused:f,pictureInPicture:w,playing:B,pointer:S,poster:A,textTrack:D,viewType:p,waiting:g}=t.$state;e.classList.add("plyr"),e.classList.add("plyr--full-ui");const T={"plyr--airplay-active":y,"plyr--airplay-supported":a,"plyr--fullscreen-active":m,"plyr--fullscreen-enabled":n,"plyr--hide-controls":d,"plyr--is-touch":()=>S()==="coarse","plyr--loading":g,"plyr--paused":f,"plyr--pip-active":w,"plyr--pip-enabled":u,"plyr--playing":B,"plyr__poster-enabled":A,"plyr--stopped":()=>f()&&$()===0,"plyr--captions-active":D,"plyr--captions-enabled":c},I=oe();for(const v of Object.keys(T))I.add(k(()=>void e.classList.toggle(v,!!T[v]())));return I.add(k(()=>{const v=`plyr--${p()}`;return e.classList.add(v),()=>e.classList.remove(v)}),k(()=>{var O;const{$provider:v}=t,R=(O=v())==null?void 0:O.type,q=`plyr--${He(R)?"html5":R}`;return e.classList.toggle(q,!!R),()=>e.classList.remove(q)})),()=>I.empty()}function He(e){return e==="audio"||e==="video"}class Ke extends qe{async loadIcons(){const t=(await pe(async()=>{const{icons:n}=await import("./vidstack-DXxIKXmd-Dge3KT8k.js");return{icons:n}},[])).icons,a={};for(const n of Object.keys(t))a[n]=Oe({name:n,paths:t[n],viewBox:"0 0 18 18"});return a}}function C(e,t){var a;return((a=e())==null?void 0:a[t])??t}function Ue(){return We()}function Ze(){const e=_(),{load:t}=e.$props,{canLoad:a}=e.$state;return ce(()=>t()==="play"&&!a())()?[J(),j()]:[ze(),Je(),j(),Xe(),mt(),_t()]}function J(){const e=_(),{translations:t}=r(),{title:a}=e.$state,n=l(()=>`${C(t,"Play")}, ${a()}`);return s`
  ...
  `}function ze(){const{controls:e}=r();return l(()=>e().includes("play-large")?J():null)}function Je(){const{thumbnails:e,previewTime:t}=r();return s`
    <media-thumbnail
      ...
      time=${l(()=>t())}
    ></media-thumbnail>
  `}function j(){const e=_(),{poster:t}=e.$state,a=l(()=>`background-image: url("${t()}");`);return s`<div class="plyr__poster" style=${a}></div>`}function We(){const e=new Set(["captions","pip","airplay","fullscreen"]),{controls:t}=r(),a=l(()=>t().filter(n=>!e.has(n)).map(W));return s`<div class="plyr__controls">${a}</div>`}function Xe(){const{controls:e}=r(),t=l(()=>e().map(W));return s`<div class="plyr__controls">${t}</div>`}function W(e){switch(e){case"airplay":return Ye();case"captions":return et();case"current-time":return ct();case"download":return dt();case"duration":return X();case"fast-forward":return ot();case"fullscreen":return tt();case"mute":case"volume":case"mute+volume":return ut(e);case"pip":return nt();case"play":return st();case"progress":return it();case"restart":return lt();case"rewind":return rt();case"settings":return yt();default:return null}}function Ye(){const{translations:e}=r();return s`
