import{_ as i,r as p,o as r,c as u,d as a,a as n,b as s,e as t}from"./app-L5l8u5i_.js";const k={},d=n("div",{class:"hint-container tip"},[n("p",{class:"hint-container-title"},"前言"),n("p",null,"其实之前已经通过node-red实现了获取云麦好轻的数据，并在Home Assistant上展示家庭体重了，但是感觉自动化还是有点欠缺。刚好借着写Blog的时候发现vuepress-theme-hope支持echarts扩展，就想着尝试通过折线图实现。")],-1),v=n("h2",{id:"成果展示",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#成果展示"},[n("span",null,"成果展示")])],-1),m=n("p",null,[s("vuepress-theme-hope内置的markdownEnhance功能，已经支持echarts图表（大部分）的展示了，可以通过await+fetch的方式引入json文件，并生成折线图。"),n("br"),s(" 效果如下：")],-1),b=n("h2",{id:"方法思路",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#方法思路"},[n("span",null,"方法思路")])],-1),y=n("p",null,"总体来说，数据处理的思路是:",-1),h=t('<h3 id="app逆向" tabindex="-1"><a class="header-anchor" href="#app逆向"><span>APP逆向</span></a></h3><p>其中对我而言最困难的就是“APP逆向”这个步骤，毕竟对抓包也只是略懂皮毛，后来花了200大洋找了大佬逆向了好轻APP登陆算法，才完成最关键也是最开始的一步。</p><h3 id="数据获取" tabindex="-1"><a class="header-anchor" href="#数据获取"><span>数据获取</span></a></h3><h4 id="javascript" tabindex="-1"><a class="header-anchor" href="#javascript"><span>Javascript</span></a></h4>',4),g={href:"https://bbs.hassbian.com/thread-20999-1-1.html",target:"_blank",rel:"noopener noreferrer"},f=t('<h4 id="python" tabindex="-1"><a class="header-anchor" href="#python"><span>Python</span></a></h4><p>其实写python脚本的时候。是照着node-red的流程来写的，编程小白在这里又一次借鉴了ChatGPT的神秘力量完成了编程，并解决了RSA加密这一最关键的一步<sup class="footnote-ref"><a href="#footnote1">[1]</a><a class="footnote-anchor" id="footnote-ref1"></a></sup>。</p><h3 id="数据化自动更新" tabindex="-1"><a class="header-anchor" href="#数据化自动更新"><span>数据化自动更新</span></a></h3>',3),q={href:"https://github.com/arthurfsy2/yunmai_weight_extract2json",target:"_blank",rel:"noopener noreferrer"},w=t(`<h2 id="参考代码" tabindex="-1"><a class="header-anchor" href="#参考代码"><span>参考代码</span></a></h2><div class="hint-container tip"><p class="hint-container-title">双人体重</p><p>修改以下代码的<br><code>const data = await fetch()</code>对应的链接、标题名称等内容即可。</p></div><div class="language-markdown line-numbers-mode" data-ext="md" data-title="md"><pre class="language-markdown"><code>:::echarts 
