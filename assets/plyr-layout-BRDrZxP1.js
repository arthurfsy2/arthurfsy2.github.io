import{ag as F,be as V,P as c,ab as q,bf as O,W as E,f as N,O as Q,bg as r,R as v,ad as K,a2 as j,ah as Z,bh as P,af as C,an as i}from"./app-D-D9cs7j.js";import{M as H,a as U,b as W,d as z,c as J,e as X,f as Y,v as ee,g as te,h as ae,i as ne,k as se,j as le,l as re,m as oe,n as ie,o as ue,p as de,q as pe,s as ce,t as me,w as _e,u as ye}from"./vidstack-D_oHMH9h-bTZ6j_Se.js";import{L as $e,x as n,a as B}from"./vidstack-rsZGrNIW-CJxWesQC.js";import{S as be,$ as l,L as fe,I as ve}from"./vidstack-DDr92MCR-CK0Et1Mh.js";import{MediaPosterElement as ge}from"./vidstack-xUn3RtTx-Bn_m5MkA.js";class we extends fe{async Pf(){const t=(await N(()=>import("./vidstack-DXxIKXmd-Dge3KT8k.js"),[])).icons,a={};for(const s of Object.keys(t))a[s]=ve({name:s,paths:t[s],viewBox:"0 0 18 18"});return a}}function g(e,t){var a;return((a=e())==null?void 0:a[t])??t}function he(){return xe()}function Me(){const e=c(),{load:t}=e.$props,{canLoad:a}=e.$state;return Q(()=>t()==="play"&&!a())()?[S(),x()]:[Te(),ke(),x(),Ee(),Ne(),Qe()]}function S(){const e=c(),{translations:t}=r(),{title:a}=e.$state,s=l(()=>`${g(t,"Play")}, ${a()}`);return n`
    <media-play-button
