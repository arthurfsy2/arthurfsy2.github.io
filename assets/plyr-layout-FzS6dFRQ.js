import{ag as F,be as V,P as c,ab as q,bf as O,W as E,f as N,O as Q,bg as r,R as v,ad as K,a2 as j,ah as Z,bh as P,af as C,an as i}from"./app-CF02xEbW.js";import{M as H,a as U,b as W,d as z,c as J,e as X,f as Y,v as ee,g as te,h as ae,i as ne,k as se,j as le,l as re,m as oe,n as ie,o as ue,p as de,q as pe,s as ce,t as me,w as _e,u as ye}from"./vidstack-D_oHMH9h-Rak9VhHy.js";import{L as $e,x as n,a as B}from"./vidstack-rsZGrNIW-CJxWesQC.js";import{S as be,$ as l,L as fe,I as ve}from"./vidstack-DDr92MCR-C5KeMLeX.js";import{MediaPosterElement as ge}from"./vidstack-xUn3RtTx-NfmAvgf2.js";class we extends fe{async Pf(){const t=(await N(()=>import("./vidstack-DXxIKXmd-Dge3KT8k.js"),[])).icons,a={};for(const s of Object.keys(t))a[s]=ve({name:s,paths:t[s],viewBox:"0 0 18 18"});return a}}function g(e,t){var a;return((a=e())==null?void 0:a[t])??t}function he(){return xe()}function Me(){const e=c(),{load:t}=e.$props,{canLoad:a}=e.$state;return Q(()=>t()==="play"&&!a())()?[S(),x()]:[Te(),ke(),x(),Ee(),Ne(),Qe()]}function S(){const e=c(),{translations:t}=r(),{title:a}=e.$state,s=l(()=>`${g(t,"Play")}, ${a()}`);return n`
    <media-play-button
  ...
  `}function qe(){const e=c(),{translations:t,invertTime:a,toggleTime:s,displayDuration:u}=r(),m=v(K(a));function $(p){!s()||u()||P(p)&&!C(p)||m.set(y=>!y)}function _(){return l(()=>u()?R():null)}return l(()=>{const{streamType:p}=e.$state,y=o(t,"LIVE"),b=o(t,"Current time"),h=l(()=>!u()&&m());return p()==="live"||p()==="ll-live"?n`
          <media-live-button
    ...
    <media-time
      ...
      aria-label=${t}
    ></media-time>
  `}function Oe(){return l(()=>{const e=c(),{translations:t,download:a}=r(),{title:s,source:u}=e.$state,m=u(),$=a(),_=j({title:s(),src:m,download:$}),p=o(t,"Download");return _?n`
          <a
            class="plyr__controls__item plyr__control"
        ...
        `:null})}function Ne(){return l(()=>{const{clickToPlay:e,clickToFullscreen:t}=r();return[e()?n`
          ...
          `:null,t()?n`
            ...
            ></media-gesture>
          `:null]})}function Qe(){const e=c(),t=v(void 0),a=l(()=>{var s;return B((s=t())==null?void 0:s.text)});return E(()=>{const s=e.$state.textTrack();if(!s)return;function u(){t.set(s==null?void 0:s.activeCues[0])}return u(),Z(s,"cue-change",u)}),n`
  ...
  `}function Ue(){return w({label:"Speed",children:We()})}function We(){const{translations:e,speed:t}=r();return n`
  ...
  `}function ze(){return w({label:"Captions",children:Je()})}function Je(){const{translations:e}=r();return n`
