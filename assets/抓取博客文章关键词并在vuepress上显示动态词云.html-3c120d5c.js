import{_ as o,r as e,o as i,c,a as n,b as s,d as a,e as l}from"./app-e14ced80.js";const u={},r={class:"hint-container tip"},d=n("p",{class:"hint-container-title"},"前言",-1),k={href:"https://github.com/vuepress-theme-hope/vuepress-theme-hope/issues/3372",target:"_blank",rel:"noopener noreferrer"},v={href:"https://paper-dragon.github.io/",target:"_blank",rel:"noopener noreferrer"},m=n("h2",{id:"成果展示",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#成果展示","aria-hidden":"true"},"#"),s(" 成果展示")],-1),b=n("div",{class:"hint-container note"},[n("p",{class:"hint-container-title"},"说明"),n("p",null,[s("以下图片是一个svg图片，因此可以通过"),n("code",null,"![]()"),s("的格式在文章的任意位置引用，且因为是矢量图，因此是在任何界面查看都是“高清无损”的。")])],-1),h={class:"hint-container tip"},y=n("p",{class:"hint-container-title"},"提示",-1),_=n("p",null,"本词云特点总结：",-1),g=n("li",null,"矢量图，很清楚",-1),f={href:"https://fonts.google.com/noto/specimen/Noto+Serif+TC",target:"_blank",rel:"noopener noreferrer"},w=n("li",null,"在Git push更新项目时可通过Github Action自动运行生成词云的python文件，并与原有deploy-docs.yml合并在一起",-1),q=n("figure",null,[n("img",{src:"https://raw.gitmirror.com/arthurfsy2/arthurfsy2.github.io/main/src/.vuepress/public/assets/img/wordcloud.svg",alt:"",tabindex:"0",loading:"lazy"}),n("figcaption")],-1),x=n("h2",{id:"方法思路",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#方法思路","aria-hidden":"true"},"#"),s(" 方法思路")],-1),X=n("p",null,[s("总体来说，词云生成的思路如下流程图。"),n("br"),s(" 通过wordcloud2Svg.py生成图片，然后将该流程集成到deploy-docs.yml当中（与部署Github Page联合一起使用）")],-1),T=l(`<h3 id="词云生成流程" tabindex="-1"><a class="header-anchor" href="#词云生成流程" aria-hidden="true">#</a> 词云生成流程</h3><p>wordcloud2Svg.py代码示例见后面章节</p><blockquote><p>具体可见本仓库的<code>src/.vuepress/public/scripts/wordcloud2Svg.py</code></p></blockquote><p>主要说明（具体说明见代码的注释）：</p><ol><li>遍历文章目录，将所有<code>.md</code>的文章内容合并为<code>contents</code></li><li>通过<code>jieba.analyse.textrank</code>来获取<code>contents</code>当中的关键词（通过topK设置关键词数量），并输出为<code>keyword_counts</code></li><li>通过<code>OpenCC</code>将<code>keyword_counts</code>转换为繁体（可根据自身喜好决定是否需要转换）</li><li>通过<code>wordcloud.generate_from_frequencies()</code>来生成词云内容</li><li>通过<code>wordcloud.to_svg(embed_font=True)</code>来生成svg内容</li><li>将最终结果写入到<code>/assets/img/wordcloud.svg</code>文件当中</li></ol><h3 id="自动生成流程" tabindex="-1"><a class="header-anchor" href="#自动生成流程" aria-hidden="true">#</a> 自动生成流程</h3><p>deploy-docs.yml代码示例如下，具体可见本仓库的<code>.github/workflows/deploy-docs.yml</code><br> 主要说明（具体说明见代码的注释）：</p><ol><li>需要修改内容<br> 将以下代码修改为你自己的github账号、邮箱</li></ol><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>env:
  GITHUB_NAME: XXXX
  GITHUB_EMAIL: XXXX
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div></details>`,18);function j(C,S){const t=e("ExternalLinkIcon"),p=e("Mermaid");return i(),c("div",null,[n("div",r,[d,n("p",null,[s("无意间看到一个"),n("a",k,[s("issue"),a(t)]),s("有提及希望vuepress-theme-hope能新增echarts的词云，看了"),n("a",v,[s("paper-dragon"),a(t)]),s("的成果，果然很赞。但是由于目前theme-hope兼容的echarts图表有限，因此采用了“另辟蹊径”的方法来实现动态获取博客所有文章关键词，然后在博客中动态显示（每git push一次就自动更新词云）")])]),m,b,n("div",h,[y,_,n("ol",null,[g,n("li",null,[s("选了自认为效果还不错的繁体字体："),n("a",f,[s(" Noto Serif TC "),a(t)])]),w])]),q,x,X,a(p,{id:"mermaid-44",code:"eJzT1dXlKsksyUm1Ung2dcuTvZOfNcx9sX09F0g8LSe/PDkjsahEIcSFq7g0Kb0osSBDoTy/KCU5J780xSi4LF2voJLr6YSOpzu3PetseDan89m09uerFzybuuFZ7zpdXbunrZtfTln3Yn3v8ynzn3VMAIpAGE9n73uyayJXal4KwtyU1IKc/ErdlPzkYr3K3ByuzBTD6Bfr9j3fu849sySjNEnBMbkkMz8vFqyLC90VQKPRDQAAeFxj1w=="}),T])}const N=o(u,[["render",j],["__file","抓取博客文章关键词并在vuepress上显示动态词云.html.vue"]]);export{N as default};
